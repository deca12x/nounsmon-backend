...
contract NounsToken is INounsToken, Ownable, ERC721Checkpointable {
    ...
    // send existing nft from minter to user
    function nounCaught(uint256 nounId, address _to) public onlyMinter {
        IERC721(address(this)).safeTransferFrom(minter, _to, nounId);
    }
